...
const GameDetails = () => {
  return (
    <div className="py-10 px-6 md:px-12 lg:px-20 bg-gray-100">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <h3 className="text-xl font-semibold text-gray-800">Release Date</h3>
              <p className="text-gray-600">3 January 2025</p>
            </div>
            <div>
              <h3 className="text-xl font-semibold text-gray-800">Developer</h3>
              <p className="text-gray-600">Luminous Productions</p>
            </div>
            <div>
              <h3 className="text-xl font-semibold text-gray-800">Publisher</h3>
              <p className="text-gray-600">Square Enix</p>
            </div>
          </div>
